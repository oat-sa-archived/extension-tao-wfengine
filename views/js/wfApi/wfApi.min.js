...
if(typeof(finish)!='function'){var _stateContext=window.top||window;function finish(){$(_stateContext).trigger(STATE.ITEM.PRE_FINISHED);$(_stateContext).trigger(STATE.ITEM.FINISHED);$(_stateContext).trigger(STATE.ITEM.POST_FINISHED);}
