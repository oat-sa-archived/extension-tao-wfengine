...
$GLOBALS['__l10n']["[TAO Notification System] Workflow"]="[Sistema de notificações TAO] Fluxo de Trabalho";
...
$GLOBALS['__l10n']["Access denied. Please renew your authentication!"]="Acesso negado. Por favor renove a autenticação!";
$GLOBALS['__l10n']["Actions"]="Acções";
$GLOBALS['__l10n']["Active Process"]="Processo Activo";
...
$GLOBALS['__l10n']["Advanced Users"]="Utilizadores Avançados";
...
$GLOBALS['__l10n']["An error occured during request processing"]="Um erro ocorreu durante o processo requerido";
...
$GLOBALS['__l10n']["Cannot create process execution"]="Não é possível criar a execução de processo";
...
$GLOBALS['__l10n']["Check All"]="Marcar Todos";
$GLOBALS['__l10n']["Check pending tasks for assessment preparation."]="Verifique as tarefas pendentes para a preparação de avaliação.";
...
$GLOBALS['__l10n']["created by"]="criado por";
...
$GLOBALS['__l10n']["execution of"]="Execução de";
...
$GLOBALS['__l10n']["Finished Process"]="Processo terminado";
$GLOBALS['__l10n']["First Name"]="Nome Próprio";
$GLOBALS['__l10n']["First row column names"]="1ª linha Nomes da coluna";
$GLOBALS['__l10n']["Forward"]="Avançar";
$GLOBALS['__l10n']["Generating cache..."]="A gerar a cache...";
$GLOBALS['__l10n']["Go Back"]="Retroceder";
$GLOBALS['__l10n']["Home"]="Inicio";
$GLOBALS['__l10n']["If"]="Se";
$GLOBALS['__l10n']["If there is no available activity or there are more than one. You will be redirected to the process main page."]="Se não houver qualquer actividade disponível ou se há mais do que uma. Você será redireccionado para a página principal do processo.";
$GLOBALS['__l10n']["Import"]="Importar";
$GLOBALS['__l10n']["Import "]="Importar";
$GLOBALS['__l10n']["Import failed"]="Falha ao importar";
$GLOBALS['__l10n']["Inclusive (AND)"]="Inclusive (AND)";
$GLOBALS['__l10n']["Initialize new Process"]="Inicializar novo processo";
...
$GLOBALS['__l10n']["Invalid login or password. Please try again."]="Nome de utilizador ou palavra-passe invalida, Por favor tente de novo.";
...
$GLOBALS['__l10n']["Launch Process"]="Executar o processo";
...
$GLOBALS['__l10n']["Loading next activity..."]="Executar próxima actividade";
...
$GLOBALS['__l10n']["Login"]="Inicio de sessão";
...
$GLOBALS['__l10n']["My roles"]="Os meus papeis";
...
$GLOBALS['__l10n']["No process definition uri given"]="Nenhuma definição dada ao processo uri";
$GLOBALS['__l10n']["No result found"]="Não foram encontrados resultados";
$GLOBALS['__l10n']["No variable code given"]="Nenhum código de variável dado";
...
$GLOBALS['__l10n']["Please confirm the deletion of the activity"]="Por favor confirme a eliminação da actividade";
...
$GLOBALS['__l10n']["Please login to access the selected activity."]="Por favor autentique-se para aceder a actividade seleccionada.";
...
$GLOBALS['__l10n']["Process Finished"]="Processo terminado";
$GLOBALS['__l10n']["Process initialization"]="Processo iniciado";
...
$GLOBALS['__l10n']["Redirect immediately"]="Redireccionar imediatamente";
$GLOBALS['__l10n']["Redirection in "]="Redirecção em";
...
$GLOBALS['__l10n']["Start/Resume the case"]="Iniciar / Reiniciar processo";
...
$GLOBALS['__l10n']["TAO - An Open and Versatile Computer-Based Assessment Platform"]="TAO - Uma Plataforma de Avaliação baseada em sistemas de informação versátil e aberta";
$GLOBALS['__l10n']["TAO Back Office"]="TAO Back Office";
$GLOBALS['__l10n']["TAO Home"]="Inicio TAO";
$GLOBALS['__l10n']["TAO Process Engine"]="Motor de processos TAO";
...
$GLOBALS['__l10n']["The activity provided in the url is no longer the up-to-date."]="A actividade fornecida no URL não se encontra actualizada.";
...
$GLOBALS['__l10n']["The link may be outdated."]="O atalho poderá estar obsoleto";
$GLOBALS['__l10n']["The Processes module allows to create Processes."]="O modulo de processos permite a criação de processos";
$GLOBALS['__l10n']["The resource is not a process definition"]="O recurso não é uma definição de processo";
$GLOBALS['__l10n']["The resource is not a process execution"]="O recurso não é uma execução de processo";
$GLOBALS['__l10n']["The resource is not an activity execution"]="O recurso não é uma execução de actividade";
...
$GLOBALS['__l10n']["The variable with the code '.\$code.' does not exists"]="A Variável com o código '.\$code.'  não existe";
...
$GLOBALS['__l10n']["Unable to log in the user"]="Impossível autenticar utilizador";
...
$GLOBALS['__l10n']["User Id."]="Id de utilizador";
$GLOBALS['__l10n']["User logged in successfully"]="Utilizador autenticado com sucesso";
$GLOBALS['__l10n']["User Management"]="Gestão de Utilizadores";
$GLOBALS['__l10n']["User name:"]="Nome de utilizador:";
$GLOBALS['__l10n']["User saved"]="Utilizador guardado";
$GLOBALS['__l10n']["Version"]="Versão";
$GLOBALS['__l10n']["Versioning"]="Versionamento";
$GLOBALS['__l10n']["Welcome to TAO Process Engine"]="Bem vindo ao Motor de processos TAO";
$GLOBALS['__l10n']["Welcome to TAO!"]="Bem-vindo ao TAO!";
$GLOBALS['__l10n']["Workflow Engine"]="Motor fluxo de trabalho";
$GLOBALS['__l10n']["WorkflowEngine Process Browser "]="Navegador do Motor de fluxo de trabalho";
$GLOBALS['__l10n']["Yes"]="Sim";
$GLOBALS['__l10n']["You cannot modify this property"]="Não pode modificar esta propriedade";
$GLOBALS['__l10n']["You will be redirected to the current activity if you are allowed to."]="Será redireccionado para a actividade actual, se tiver permissões.";
