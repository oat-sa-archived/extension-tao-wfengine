 ...
 *
 * Automatically generated on 23.12.2010, 12:37:50 with ArgoUML PHP module 
    ...
    extends tao_models_classes_GenerisService
{
     ...
     * @param  Resource followingActivity
     * @param  Resource newActivityLabel
     * @param  boolean followingActiivtyisConnector
     * @return core_kernel_classes_Resource
     */
    public function createSplitActivity( taoItems_models_classes_QTI_Resource $connector, $connectionType,  core_kernel_classes_Resource $followingActivity = null,  core_kernel_classes_Resource $newActivityLabel = '', $followingActiivtyisConnector = false)
    {
        $returnValue = null;
    ...
    /**
     * Short description of method setConnectionType
     *
     * @access public
     * @author Somsack SIPASSEUTH, <s.sipasseuth@gmail.com>
     * @param  Resource connector
     ...
     * @return boolean
     */
    public function setConnectionType( core_kernel_classes_Resource $connector,  core_kernel_classes_Resource $typeOfConnector)
    {
        $returnValue = (bool) false;
